...
export function getDepAndDgDoctor (deptId, dgId) {
  return request({
    url: `/doctorMain?deptId=${deptId}&dgId=${dgId}`,
    method: 'get'
  })
}
...
export function getDepAndDgHoDoctor (deptId, dgId, hospId) {
  return request({
    url: `/doctorMain?deptId=${deptId}&dgId=${dgId}&hospId=${hospId}`,
    method: 'get'
  })
}
...
export function getDeptHoDoctor (Id, hospId) {
  return request({
    url: `/doctorMain?deptId=${Id}&hospId=${hospId}`,
    method: 'get'
  })
}
...
export function getDgHoDoctor (dgId, hospId) {
  return request({
    url: `/doctorMain?dgId=${dgId}&hospId=${hospId}`,
    method: 'get'
  })
}
...
export function getdoctorByName (docName) {
  return request({
    url: `/doctorMain?docName_like=${docName}`,
    method: 'get'
  })
}
